...
SRC_FILE = base.c ft_qsort.c buff_auto.c buff_auto1.c buff_auto2.c buff_motion.c buff_motion1.c buff_motion2.c buff_motion10.c \
           ...
           job.c job1.c job2.c job3.c job4.c job5.c job5bis.c job6.c job7.c job8.c job9.c job10.c job11.c job12.c \
           lst.c \
           parser.c parser1.c parser2.c parser3.c get_redirection.c heretag.c \
           setenv.c \
           freetoken.c token.c tokentype.c \
           unset.c \
	       fg.c bg.c job_.c job_target.c disown.c env.c env1.c
